...
"""
function real_time_weight(r, m, Q; J=1, β=1, Δt=0.1)
...
- `J::Real=1`: Hopping integral
- `N::Int=100`: Number of lattice sites

# Returns
- `I::Complex`: Value of the propagator I(z; Δr)
"""
function real_time_I(z, Δr; J=1, N=100)
